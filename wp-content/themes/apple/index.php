<?php
$temp_html_dir = THEME_DIR_URI .'/junno/';
?>
<!DOCTYPE html>
...
<head>
	...
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/x-icon" href="<?php echo $temp_html_dir; ?>assets/img/favicon.ico" />
	...
	****************************-->
	 ...
	 ***********************************************-->
	<!-- <link rel="stylesheet" href="<?php echo $temp_html_dir; ?>assets/css/vendor/vendor.min.css" />
	<link rel="stylesheet" href="<?php echo $temp_html_dir; ?>assets/css/plugins/plugins.min.css" />
	<link rel="stylesheet" href="<?php echo $temp_html_dir; ?>assets/css/style.min.css" /> -->
</head>
			...
			<div class="row align-items-center">
				<div class="col-sm-6 col-lg-2 order-first">
					<div class="logo text-center text-sm-left mb-30 mb-sm-0">
						<a href="index.html"><img src="<?php echo $temp_html_dir; ?>assets/img/logo/logo-dark.jpg" alt="logo"></a>
					</div>
				</div>
				<div class="col-sm-6 col-lg-5 col-xl-4">
					...
					<div class="d-flex align-items-center justify-content-center justify-content-sm-end">
						<div class="media static-media mr-50 d-none d-lg-flex">
							<img class="mr-3 align-self-center" src="<?php echo $temp_html_dir; ?>assets/img/icon/1.png" alt="icon">
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title text-center mb-15">
					<h2 class="title text-dark text-capitalize">blog list left sidebar</h2>
				</div>
			</div>
			<div class="col-12">
					...
					<div class="col-12 mb-30">
						<div class="single-blog media flex-column flex-md-row">
							...
							<div class="blog-post-content media-body mb-5 mb-md-0">
								<h3 class="title mb-15"><a href="single-blog.html">This is first Post For XipBlog</a>
								</h3>
					...
					<div class="sidebar-widget theme1 mb-30">
						...
						<div class="blog-search-form">
							<form action="#" class="position-relative">
								<input class="form-control border-blue rounded" type="text"
									   placeholder="Enter your search key ...">
								<button class="btn blog-search-btn" type="submit"><i
					...
					<div class="sidebar-widget mb-30">
						...
						<div class="blog-media-list mb-30 media">
							<div class="post-thumb mr-4">
								<a href="#"><img src="<?php echo $temp_html_dir; ?>assets/img/blog-post/1.jpg" alt="img"></a>
							</div>
							<div class="media-body">
						...
						<div class="blog-media-list mb-30 media">
							<div class="post-thumb mr-4">
								<a href="#"><img src="<?php echo $temp_html_dir; ?>assets/img/blog-post/2.jpg" alt="img"></a>
							</div>
							<div class="media-body">
						...
						<div class="blog-media-list mb-30 media">
							<div class="post-thumb mr-4">
								<a href="#"><img src="<?php echo $temp_html_dir; ?>assets/img/blog-post/3.jpg" alt="img"></a>
							</div>
							<div class="media-body">
					...
					<div class="footer-widget">
						...
						<div class="store d-flex">
							<a href="https://www.apple.com/" class="d-inline-block mr-3"><img
										src="<?php echo $temp_html_dir; ?>assets/img/icon/apple.png" alt="apple icon"> </a>
							<a href="https://play.google.com/store/" class="d-inline-block"><img
										src="<?php echo $temp_html_dir; ?>assets/img/icon/play.png" alt="apple icon"> </a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12 col-md-6 col-lg-8">
					<div class="text-left">
						<img src="<?php echo $temp_html_dir; ?>assets/img/payment/1.png" alt="img">
					</div>
				</div>
			</div>
		</div>
